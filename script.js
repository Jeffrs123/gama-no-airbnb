...
// Realizanod a requisiÃ§Ã£o com a API.
...
/**
 * CÃ¡lcula os itens que irÃ£o ser mostrados na pÃ¡gina.
 * 
 * @param {array} items 
 ...
 */
function pagination(items, pageActual = 1, limitItems = 9) {
    let result = [],
            ...
            <div class="col-sm-12 col-md-6 col-lg-4">
                <div class="card m-auto border-0">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text content__card-price"><strong>R$ ${format_number(element.price, 2, "", ".")}</strong><span>,00</span>/ diaria</p>
                        <a href="#">Reservar</a>
                    </div>
                </div>
            </div>
...
/**
 * Imprime o HTML dos links da paginaÃ§Ã£o na pÃ¡gina.
 * 
 * @param {array} items Array de objetos contendo os elementos a serem mostrados.
 * @param {number} pageActual Index da paginaÃ§Ã£o atual.
 * @return void
 */
 ...
 * 
 * @param {number} items nÃºmero de locaÃ§Ãµes.
 * @return void
 */
...
/**
 * Limpa o conteÃºdo dos links da pÃ¡ginaÃ§Ã£o.
 * 
 * @return void
 */
...
/**
 * ResponsÃ¡vel por executar Ã  paginaÃ§Ã£o.
 * 
 * @return void
 */
...
// Carregando as informaÃ§Ãµes da API.
sendRequestAPI(URL);